...
class JsonPatchOperationBuilderTests {
	...
	void given_add_operation() {
		...
		JsonPatchOperation operation = builder.add().setPath("/foo").setValue(NullNode.getInstance()).build();
	...
	void given_replace_operation() {
		...
		JsonPatchOperationBuilder builder = new JsonPatchOperationBuilder();
		JsonPatchOperation operation = builder.replace().setPath("/foo").setValue(NullNode.getInstance()).build();
	...
	void given_test_operation() {
		...
		JsonPatchOperationBuilder builder = new JsonPatchOperationBuilder();
		JsonPatchOperation operation = builder.test().setPath("/foo").setValue(NullNode.getInstance()).build();
